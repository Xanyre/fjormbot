...
exports.prettyPrint = function(video) {
  ...
  return `**${video.title}** by **${video.author.name}** *(${viewCount} views)* [${exports.prettyTime(video.length_seconds*1000)}]`;
};

exports.prettyPrintWithUser = function(video) {
  return exports.prettyPrint(video) + `, added by <@${video.username}>`;
};
